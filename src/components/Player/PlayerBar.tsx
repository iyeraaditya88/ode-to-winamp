            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-4">
                <button
                  ...
                  title="Shuffle"
                  className={`transition-colors ${shuffle ? 'text-[#00b4b4]' : 'text-white/35 hover:text-white/70'}`}
                >
            ...
            <div className="flex items-center justify-end gap-3">
              ...
              <button
                ...
                className={`transition-colors text-xs font-mono tracking-widest px-2 py-1 rounded-sm border ${
                  showEqualizer ? 'border-[#00b4b4]/50 text-[#00b4b4]' : 'border-white/10 text-white/30 hover:text-white/60'
                }`}
              >
                EQ
              </button>
              ...
              <button
                ...
                title="Lyrics"
                className={`transition-colors ${showLyrics ? 'text-[#00b4b4]' : 'text-white/30 hover:text-white/60'}`}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <button
                ...
                disabled={!currentTrack}
                title="Expand player"
                className="text-white/30 hover:text-white/60 transition-colors disabled:opacity-20 hidden sm:block"
              >
